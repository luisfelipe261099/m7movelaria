...
const FERRAGENS = [
  {
    name: "Corrediças ocultas Häfele com amortecedor",
    uso: "Gavetas de alto padrão com fechamento silencioso.",
  },
  {
    name: "Dobradiças Salice clip reto",
    uso: "Portas de sobrepor total com folgas mínimas e esquadro perfeito.",
  },
  ...
  {
    name: "Kit RO-82 TOP Max Rometal",
    uso: "Portas de armário deslizantes com trilho superior embutido.",
  },
  ...
  {
    name: "Articuladores inversos FGV",
    uso: "Portas basculantes com curso invertido para painéis de TV.",
  },
