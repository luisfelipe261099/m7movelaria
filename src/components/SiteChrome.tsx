...
export function WhatsAppFlutuante() {
  return (
    ...
    >
      ...
      {/* Letra escura: branco sobre o verde do WhatsApp mede 1,98:1 e reprova
          em qualquer critério de contraste. O ícone continua branco porque é a
          marca reconhecível; o contraste do controle vem do verde contra o
          fundo escuro da página. */}
      <span className="hidden sm:inline text-sm font-semibold text-[#0b2e18]">WhatsApp</span>
    </a>
  );
}
...
export function SiteFooter() {
  return (
    <>
      ...
      <WhatsAppFlutuante />
      <footer className="bg-ink-surface text-white/80 defer-render">
