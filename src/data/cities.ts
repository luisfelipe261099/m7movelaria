...
const content: Record<string, CityBody> = {
  "sao-jose-dos-pinhais": {
    logistics:
      "O ateliê da M7 fica em São José dos Pinhais, na R. Henrique Bortolan, 182, no bairro Costeira. Aqui a visita técnica, a medição e a instalação acontecem na mesma cidade da produção — o que encurta o caminho entre um ajuste no projeto e a peça pronta.",
    intro: [
    ...
    faq: [
      {
        ...
        a: "Na R. Henrique Bortolan, 182, bairro Costeira, São José dos Pinhais - PR. O atendimento é de segunda a sexta, das 8h às 18h, e aos sábados das 8h às 12h. A visita ao ateliê é combinada previamente pelo WhatsApp para garantir que haja alguém disponível para te acompanhar.",
      },
      {
  ...
  curitiba: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Dá, e recomendamos. O ateliê fica na R. Henrique Bortolan, 182, no bairro Costeira, em São José dos Pinhais, a poucos minutos da divisa com Curitiba. É onde você vê o acabamento e a ferragem de perto, em vez de decidir por foto.",
      },
    ],
  },
  pinhais: {
