...
| `/links` | Página de link da bio do Instagram — HTML puro, sem JS, `noindex` e fora do sitemap. Mostra "aberto agora / abre amanhã às 8h" calculado no servidor |
...
| Botões da página do Instagram | `src/routes/links.tsx` (array `GROUPS`) |
